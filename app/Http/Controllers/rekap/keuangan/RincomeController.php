...
class RincomeController extends Controller
{
    ...
    public function gaji_info($id)
    {
        ...
        return view('asset.sad.rekap.gaji.gaji_info', compact('kar_list','cek_kar','nav', 'str_harian', 'str_bulanan','str_ins','str_lem', 'a','ai','al', 'master', 'tot_hm', 'tot_jam', 'grand_tot', 'insentif', 'kar_m', 'tot_jam_lemburan', 'lemburan', 'gaji_pokok_raw', 'periode', 'kar', 'abs_h', 'abs_s', 'hari_valid', 'abs_stk', 'abs_i', 'abs_a', 'abs_c'));
    }
}
