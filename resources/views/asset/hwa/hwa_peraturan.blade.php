    ...
    <div class="card mb-3 bg-light shadow-none">
        ...
        <div class="card-header d-flex align-items-center z-index-1 p-0">
            ...
            <div class="ms-n3">
                ...
                <h4 class="mb-0 text-primary fw-bold">Peraturan Perusahaan</h4>
            </div>
        </div>
    </div>
    ...
    <div class="accordion" id="accordionExample">
        <div class="accordion-item">
            <h2 class="accordion-header" id="heading2"><button class="accordion-button collapsed" type="button"
                    data-bs-toggle="collapse" data-bs-target="#collapse2" aria-expanded="true" aria-controls="collapse2">Ubah Peraturan </button></h2>
