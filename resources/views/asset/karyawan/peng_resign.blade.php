    ...
    <div class="card mb-3 bg-light shadow-none">
        ...
        <div class="card-header d-flex align-items-center z-index-1 p-0"><img
            ...
            <div class="ms-n3">
                ...
                <h4 class="mb-0 text-primary fw-bold">Permohonan Resign<span class="text-info fw-medium"></span></h4>
            </div>
        </div>
    </div>
        ...
        <div class="tab-pane preview-tab-pane active" role="tabpanel"
            ...
            <div class="collapse" id="collapseExample">
                <div class="border p-x1 rounded">
                    <form action="{{ route('peng.resign.s') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card mb-3">
                            ...
                            <div class="card-body mb-4">
                                <div class="col-12">
                                    ...
                                    <input class="form-control" accept=".pdf" type="file" value="{{ old('file') }}"
                                        name="surat" />
                                    @error('surat')
                                        <div class="text-danger mt-2 fs--1">{{ $message }}</div>
                                    @enderror
