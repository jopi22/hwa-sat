...
@section('judul')
    Barang Keluar | Arsip | HWA &bull; SAT
@endsection
...
@section('konten')
    <div class="card mb-3 bg-light shadow-none">
        ...
        <div class="card-header d-flex align-items-center z-index-1 p-0">
            ...
            <div class="ms-n3">
                <h6 class="mb-1 text-primary"><i class="fas fa-file-archive"></i> Logistik <a
                        href="{{ route('amast.g') }}"><span class="text-danger">Master Arsip</span></a>
                    {{ $master->created_at->format('F Y') }}
                </h6>
                <h4 class="mb-0 text-primary fw-bold">Barang Keluar <span class="mb-1 text-info"></span> </h4>
            </div>
        </div>
    </div>
