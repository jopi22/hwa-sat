                ...
                <div class="card-header border-bottom border-200 px-0">
                    <div class="d-lg-flex justify-content-between">
                        ...
                        <div class="d-flex align-items-center justify-content-between justify-content-lg-end px-x1"><button
                                ...
                                data-bs-target="#ticketOffcanvas" aria-controls="ticketOffcanvas"><span
                            ...
                            <div class="d-flex align-items-center" id="table-ticket-replace-element">
                                <div class="dropdown"><button
                                        ...
                                        type="button" id="ticket-layout" data-bs-toggle="dropdown" data-boundary="window"
                            ...
                            <div class="d-flex align-items-start align-items-sm-center">
                                <a class="d-none d-sm-block" href="contact-details.html">
                                    <div class="avatar avatar-xl avatar-3xl">
                                        <div class="avatar-name rounded-circle"><span>{{$item->created_at->format('M')}}</span></div>
                                    </div>
                                </a>
                                        ...
                                        <div class="col-auto me-2">
                                            <h6 class="client mb-0"><a
                                                    ...
                                                    href="contact-details.html"><span class="fas fa-user"
                                                        data-fa-transform="shrink-3 up-1"></span><span>{{$item->created_at->format('F Y')}}</span></a></h6>
                                        </div>
                                        <div class="col-auto lh-1 me-3"><small
                                                class="badge rounded badge-soft-success false">Arsip</small></div>
                                        <div class="col-auto">
                                            <h6 class="mb-0 text-500">{{$item->updated_at->diffforhumans()}}</h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
