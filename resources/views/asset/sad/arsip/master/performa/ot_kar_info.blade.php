...
@section('judul')
    {{ $kar->id }} | Validasi | Performa Helper | HWA &bull; SAT
@endsection
        ...
        <div class="row gx-0 kanban-header rounded-2 px-x1 py-2 mt-2 mb-3">
            <div class="col d-flex align-items-center">
                <div>
                    ...
                    <a href="{{ route('ot.k') }}"><button class="btn btn-link btn-dark btn-sm p-0"><i
                                class="fas fa-list text-primary"></i></button></a>
                    <a href="{{ route('ot.k.i', Crypt::encryptString($kar->id)) }}"><button
