        ...
        $("#addBtn").on("click", function() {
            ...
            <tr class="btn-reveal-trigger text-center text-1000 fw-semi-bold">
                ...
                class="fas fa-plus-square fs-2"></i></a>
                                <input type="hidden" name="jenis[]" value="Vehicle">
...
<div class="card mb-3">
    <div class="card-body d-flex justify-content-between">
        <div>
            ...
            <a class="btn btn-falcon-default btn-sm" href="{{ route('vehicle.l') }}" data-bs-toggle="tooltip"
                data-bs-placement="top" title="Back to Main Table">
                <span class="fas fa-list"></span>
            </a>
            <span class="mx-1 mx-sm-2 text-300">| </span>
            <span class=" fw-semi-bold text-primary"> Tambah Vehicle</span>
        </div>
    </div>
</div>
    ...
    <form action="{{ route('equip.s') }}" method="post">
        ...
        <div class="card mb-3">
            <div class="card-header text-center bg-success py-2">
                <h5 class="text-white"><i class="fas fa-truck-monster"></i> Form Tambah Vehicle</h5>
            </div>
