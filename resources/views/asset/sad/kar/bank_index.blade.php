...
@section('superadmin')
                ...
                <table class="table table-sm table-striped table-bordered fs--1 mb-0 overflow-hidden">
                    <thead class="bg-secondary text-white text-center">
                        <tr>
                            ...
                            <th style="min-width: 900px" class="sort" data-sort="name">
                                Bank
                            </th>
                        </tr>
                    </thead>
    ...
    @include('comp.modal.bank.modal_bank_create')
    @include('comp.modal.bank.modal_bank_edit')
    @include('comp.modal.bank.modal_bank_delete')
@endsection
