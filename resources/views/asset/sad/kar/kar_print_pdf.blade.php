...
<head>
    ...
    <link href="{{ asset('assets/print/css/kar_pdf.css') }}" rel="stylesheet">
</head>
...
<body class="p">
    ...
    <div id="invoice">
        ...
        <article>
            ...
            <table class="meta">
                <tr>
                    <th><span>Staf</span></th>
                    <td><span>{{ $staf }}</span></td>
                </tr>
                <tr>
                    <th><span>Operator/Driver</span></th>
                    <td><span>{{ $od }}</span></td>
                </tr>
                <tr>
                    <th><span>Helper/Mekanik</span></th>
                    <td><span>{{ $ot }}</span></td>
                </tr>
                <tr>
