        ...
        $("#addBtn").on("click", function() {
            ...
            $("#tableEstimate tbody").append(`
                <tr class="btn-reveal-trigger text-1000 fw-semi-bold">
                    ...
                    <td class="align-middle text-1000 text-center white-space-nowrap tgl">
                        <input required max="1000" type="number" class="form-control " name="pagi[]">
                    </td>
                    <td class="align-middle text-1000 text-center white-space-nowrap tgl">
                        <input required max="1000" type="number" class="form-control " name="siang[]">
                    </td>
                    <td class="align-middle text-1000 text-center white-space-nowrap tgl">
                        <input required max="1000" type="number" class="form-control " name="sore[]">
                    </td>
                    <td class="align-middle text-1000 text-center white-space-nowrap tgl">
                        <input required max="1000" type="number" class="form-control " name="malam[]">
                    </td>
                    <td class="align-middle text-1000 text-center white-space-nowrap tgl">
                        <input required maxlength="50" type="text" class="form-control " name="ket[]">
                    </td>
                </tr>
                `);
        });
...
@section('konten')
    ...
    <div class="row gx-0 kanban-header rounded-2 px-x1 py-2 mb-2">
        <div class="col d-flex align-items-center">
            <div class="ms-1">&nbsp;
                <span class=" fw-semi-bold text-primary"> Tambah Catering </span>
            </div>
        </div>
                ...
                <div class="d-lg-flex justify-content-between">
                    <div class="row flex-between-center gy-2 px-x1">
                        <div class="col-auto pe-0">
                            <a class="btn btn-falcon-default btn-sm" href="{{ route('cat.l') }}" data-bs-toggle="tooltip"
                    ...
                    <table id="tableEstimate" class="table table-sm table-striped table-bordered mb-0 fs--1"
                        ...
                        <tbody id="table-posts" class="list">
                            <tr class="btn-reveal-trigger text-1000 fw-semi-bold">
                                ...
                                <td class="align-middle text-1000 text-center white-space-nowrap tgl">
                                    <input required max="1000" type="number" class="form-control "
                                        name="pagi[]">
                                </td>
                                <td class="align-middle text-1000 text-center white-space-nowrap tgl">
                                    <input required max="1000" type="number" class="form-control "
