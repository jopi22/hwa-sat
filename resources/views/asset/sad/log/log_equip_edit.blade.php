...
@section('judul')
    {{ $equip_m->equip_->no_unit }} | Edit Barang Keluar | HWA &bull; SAT
@endsection
...
@section('superadmin')
    @if ($master->periode == $periode)
        <div class="row gx-0 kanban-header rounded-2 px-x1 py-2 mt-2 mb-3">
            <div class="col d-flex align-items-center">
                <div>
                    ...
                    <a href="{{ route('log.e.e', Crypt::encryptString($equip_m->equip_id)) }}"><button
            ...
            <div class="col-auto d-flex align-items-center">
                <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                    <a href="{{ route('log.e.i', Crypt::encryptString($equip_m->equip_id)) }}">
                    ...
                    <a href="{{ route('log.e.e', Crypt::encryptString($equip_m->equip_id)) }}">
                    ...
                    <a href="{{ route('log.e.c', Crypt::encryptString($equip_m->equip_id)) }}">
        ...
        <form action="{{ route('log.e.u') }}" method="post">
            @csrf
            <div class="card mb-3">
                                            ...
                                            <tr id="index_{{ $res->id }}"
                                                ...
                                                <td class="align-middle text-1000 white-space-nowrap log">
                                                    <input required maxlength="100" class="form-control form-control-sm"
                                                        type="text" name="barang[]" value="{{ $res->barang }}">
                                                </td>
                                                <td class="align-middle text-1000 text-center white-space-nowrap jum">
                                                    <input required max="100000000" class="form-control form-control-sm"
                                                        type="number" name="jumlah[]" value="{{ $res->jumlah }}">
                                                </td>
                                                <td class="align-middle text-1000 text-center white-space-nowrap jum">
                                                    <input required maxlength="10" class="form-control form-control-sm"
                                                        type="text" name="satuan[]" value="{{ $res->satuan }}">
                                                </td>
                                                <td class="align-middle text-1000 text-center white-space-nowrap hm">
                                                    <input required max="100000000" class="form-control form-control-sm"
                                                        type="number" name="hmkm[]" value="{{ $res->hmkm }}">
                                                </td>
                ...
                <div class="card-footer bg-light d-flex flex-between-center py-2">
                    <button class="btn btn-warning ms-2 mt-2 mb-2 btn-sm"><i class="fas fa-save"></i> Update</button>
                </div>
            </div>
        </form>
    @else
