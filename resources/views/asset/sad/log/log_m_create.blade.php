...
@section('judul')
 Tambah Barang Masuk | HWA &bull; SAT
@endsection
        ...
        $("#addBtn").on("click", function ()
            {
                ...
                <tr class="btn-reveal-trigger text-1000 fw-semi-bold">
                    <td class="align-middle text-center text-1000 white-space-nowrap no">
                        ...
                        <input type="hidden" name="log_tipe[]" value="Masuk">
                    </td>
...
@section('superadmin')
    ...
    <div class="row gx-0 kanban-header rounded-2 px-x1 py-2 mt-2 mb-3">
        <div class="col d-flex align-items-center">
            ...
            <div class="ms-1">&nbsp;
                <span class=" fw-semi-bold text-primary"> Tambah Barang Masuk</span>
            </div>
        </div>
    </div>
    ...
    <form action="{{ route('log.m.s') }}" method="post">
        @csrf
        <div class="card mb-3">
