...
@section('judul')
    {{-- {{ $equip_m->equip_->no_unit }} | Breakdown | HWA &bull; SAT --}}
@endsection
...
@section('superadmin')
    <div class="row gx-0 kanban-header rounded-2 px-x1 py-2 mt-2 mb-3">
        <div class="col d-flex align-items-center">
            <div>
                ...
                <a href="{{ route('bd.i', Crypt::encryptString($equip_m->equip_id)) }}"><button
    ...
    <div class="offcanvas offcanvas-end" id="offcanvasRight" tabindex="-1" aria-labelledby="offcanvasRightLabel">
        <div class="offcanvas-header">
            <h5 id="offcanvasRightLabel"><i class="fas fa-truck-monster"></i> Breakdown</h5><button
                                    ...
                                    <tr id="index_{{ $res->id }}" class="btn-reveal-trigger text-1000 fw-semi-bold">
                                        <td class="align-middle text-center text-1000 white-space-nowrap no">
                                            <div class="btn-group  btn-group-sm" role="group">
                                                <a href="{{ route('bd.i', Crypt::encryptString($res->id)) }}"
                    ...
                    <table class="table table-sm table-striped table-bordered mb-0 fs--1"
                        ...
                        <thead class="bg-200 text-800">
                            <tr class="text-center text-white bg-secondary">
                                ...
                                <th style="min-width: 350px; max-width: 400px;" class="sort align-middle white-space-nowrap"
                                    data-sort="payment">Operator /
                                    Driver
                                </th>
                                <th style="min-width: 100px" class="bg-primary text-white align-middle white-space-nowrap">
                                    Jam Awal</th>
                                <th style="min-width: 100px"
                                    class="bg-primary text-white align-middle white-space-nowrap text-center">
                                    Jam Akhir
                                </th>
                                <th style="min-width: 100px" class="bg-primary text-white align-middle white-space-nowrap">
                                    Jam
