    ...
    @if ($master->periode == $periode)
        @if ($master->ket2 == 1)
                            ...
                            <div class="border p-x1 rounded">
                                <form action="{{ route('ha.s') }}" method="post">
                                    ...
                                    <div class="text-center">
                                        <button class="btn btn-sm btn-success mt-3" type="submit"><i
                                                class="fas fa-save"></i>
                                            Simpan</button>
                                    </div>
                                </form>
            ...
            @foreach ($hauling as $res)
                <div class="modal fade" id="edit-{{ $res->id }}" data-bs-keyboard="false"
                                                        ...
                                                        <div class="mb-2">
                                                            <div class="form-floating">
                                                                <input required value="{{ $res->tgl }}"
                                                                    ...
                                                                    id="datetimepicker" name="tgl" type="text"
                        ...
                        <div class="modal-content border-0">
                            ...
                            <div class="modal-footer">
                                <button data-bs-dismiss="modal" aria-label="Close" type="button"
                                    class=" btn btn-light"><i class="fas fa-times"></i> Batal</button>
