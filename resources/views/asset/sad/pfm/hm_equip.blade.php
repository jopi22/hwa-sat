            ...
            <div class="card mb-2 bg-light shadow-none">
                ...
                <div class="card-header d-flex align-items-center z-index-1 p-0"><img
                    ...
                    <div class="ms-n3">
                        ...
                        <h4 class="mb-0 text-primary fw-bold">Kelola Hours Meter
                    ...
                    <div class="row flex-between-left">
                        <div class="col-auto ms-2">
                            <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                                <a href="{{ route('hm.e') }}"><button class="btn active btn-sm text-warning"
                                        type="button"><i class="fas fa-stopwatch"></i> Reguler</button></a>
                                <a href="{{ route('hm.m') }}"><button class="btn btn-sm text-primary" type="button"><i
                                ...
                                <thead class="bg-secondary text-white">
                                    <tr class="text-center">
                                        ...
                                        <th style="min-width: 80px; max-width: 400px;"
                                            class="sort align-middle white-space-nowrap" data-sort="lok">Alokasi
                                        </th>
                                    </tr>
                                </thead>
