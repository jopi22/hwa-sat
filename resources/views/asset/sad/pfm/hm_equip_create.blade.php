                        ...
                        <select name="kar_id[]" class="form-select form-select-sm">
                            ...
                            @foreach ($kar as $item)
                                <option value="{{ $item->id }}">{{ $item->name }} |
                                    K{{ $item->tgl_gabung->format('ym') }}{{ $item->id }} | {{ $item->jabatan }}
                                </option>
                            @endforeach
                        </select>
                    </td>
...
<div class="row gx-0 kanban-header rounded-2 px-x1 py-2 mt-2 mb-3">
    <div class="col d-flex align-items-center">
        <div>
            ...
            <a href="{{ route('hm.e.c', Crypt::encryptString($equip_m->equip_id)) }}"><button class="btn btn-link btn-dark btn-sm p-0"><i
        ...
        <div class="ms-1">&nbsp;
            <span class=" fw-semi-bold text-primary"> {{ $equip_m->equip_->tipe }} <span class="fw-semi-bold text-info">{{ $equip_m->equip_->no_unit }}</span></span>
        </div>
    </div>
    <div class="col-auto d-flex align-items-center">
        ...
        <div class="position-relative">&nbsp;
            <div class="dropdown font-sans-serif d-inline-block">
                <button class="btn btn-sm btn-falcon-default dropdown-toggle" id="dropdownMenuButton" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></button>
...
<div class="offcanvas offcanvas-end" id="offcanvasRight" tabindex="-1" aria-labelledby="offcanvasRightLabel">
    <div class="offcanvas-header">
        <h5 id="offcanvasRightLabel"><i class="fas fa-truck-monster"></i> Performa Equiment</h5><button class="btn-close text-reset" type="button"
                ...
                <table id="tableEstimate" class="table table-sm table-striped table-bordered mb-0 fs--1"
                    ...
                    <thead class="bg-200 text-800">
                        <tr class="text-center bg-secondary text-white">
                            ...
                            <th style="min-width: 150px"
                                class="sort bg-primary align-middle white-space-nowrap">HM
                                Potongan
                            </th>
                            <th style="min-width: 150px"
                                class="sort bg-primary align-middle white-space-nowrap">HM
                    ...
                    <tbody id="table-posts" class="list">
                        <tr class="btn-reveal-trigger text-1000 fw-semi-bold">
                            ...
                            <td class="align-middle text-1000 text-center white-space-nowrap">
                                <input required type="number" class="form-control form-control-sm" name="hm_akhir[]">
                            </td>
                            <td class="align-middle text-1000 text-center white-space-nowrap">
                                <input type="number" class="form-control form-control-sm" name="hm_pot[]">
                            </td>
