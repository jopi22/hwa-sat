        ...
        <div class="card mb-2 bg-light shadow-none">
            ...
            <div class="card-header d-flex align-items-center z-index-1 p-0"><img
                ...
                <div class="ms-n3">
                    ...
                    <h4 class="mb-0 text-primary fw-bold">Kelola Hours Meter Manual
                            ...
                            <table class="table table-sm table-bordered mb-0 fs--1"
                                ...
                                <thead class="bg-secondary text-white">
                                    <tr class="text-center">
                                        ...
                                        <th style="min-width: 80px" class="sort text-white bg-primary align-middle white-space-nowrap">
                                            Jam Awal</th>
                                        <th style="min-width: 80px"
                                            class="sort bg-primary align-middle text-white white-space-nowrap text-center">
                                            Jam Akhir
                                        </th>
                                        <th style="min-width: 80px" class="sort text-white bg-primary align-middle white-space-nowrap">
                                            Jam Total
                                        ...
                                        <th style="min-width: 80px" class="sort text-white bg-danger align-middle white-space-nowrap">
                                            HM
                                            Potongan
                                        </th>
