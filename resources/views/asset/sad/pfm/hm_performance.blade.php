            ...
            <div class="card overflow-hidden mb-3">
                        ...
                        <div class="col-auto ms-2">
                            <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                                ...
                                <button class="btn btn-sm text-primary" data-bs-toggle="pill" data-bs-target="#asdasda"
                                    type="button" role="tab" aria-controls="asdasda" aria-selected="false"
                                    id="tab-asdasda"><i class="fas fa-chart-bar"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card-body p-0">
                    <div class="tab-content">
                                        ...
                                        <table class="table table-sm table-striped table-bordered mb-0 fs--1"
                                            ...
                                            <thead class="bg-200 text-800">
                                                <tr class="text-center bg-secondary text-white">
                                                    ...
                                                    <th style="min-width: 120px"
                                                        class="sort align-middle white-space-nowrap" data-sort="payment">No
                                                        Unit
                                                    </th>
                                                    <th style="min-width: 120px"
                                                        class="sort align-middle white-space-nowrap" data-sort="id">
                                                        Id O/D
                                                    </th>
                                            ...
                                            <tbody id="table-posts" class="list">
                                                @foreach ($perform_list as $res)
                                                    <tr id="index_{{ $res->id }}"
                                                        ...
                                                        <td
                                                            class="align-middle text-1000 text-center white-space-nowrap id">
                                                            @if ($res->kar_id)
                                            ...
                                            <tbody id="table-posts" class="list">
                                                @foreach ($equip as $res)
                                                    <tr id="index_{{ $res->id }}"
                                                        ...
                                                        <td
                                                            class="align-middle text-1000 text-center white-space-nowrap name">
                                                            PT. CMI
                                                        </td>
                                                    </tr>
                                                @endforeach
                        ...
                        {{-- // O/D // --}}
                        <div class="tab-pane code-tab-pane" role="tabpanel"
                            aria-labelledby="tab-dom-91d68b2e-028d-47b6-9a26-22" id="dom-91d68b2e-028d-47b6-9a26-22">
                            <div id="tableExample4"
                                            ...
                                            <tbody id="table-posts" class="list">
                                                @foreach ($kar_list as $res)
                                                    <tr id="index_{{ $res->id }}"
                                                        ...
                                                        <td
                                                            class="align-middle text-1000 text-center white-space-nowrap hm">
                                                            @if ($res->hm_total)
                                                                {{ $res->hm_total }}
                                                            @else
                                                                -
                                                        ...
                                                        <td
                                                            class="align-middle text-1000 text-center white-space-nowrap ins">
                                                            @if ($res->insentif)
                                                                <h6
                        ...
                        {{-- // Grafik // --}}
                        <div class="tab-pane code-tab-pane " role="tabpanel" aria-labelledby="tab-asdasda"
                            id="asdasda">
                            <div class="card">
                                ...
                                <div class="card-footer bg-light py-2">
                                    <div class="row flex-between-center g-0">
                                        <div class="col-auto"><select
                                                class="form-select form-select-sm audience-select-menu">
