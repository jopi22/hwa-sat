...
@section('judul')
    Adjustment | Rekapitulasi | HWA &bull; SAT
@endsection
                    ...
                    <table class="table table-sm table-bordered mb-0 fs--1"
                        ...
                        <thead class="bg-secondary text-white">
                            <tr class="text-center">
                                ...
                                <th style="min-width: 180px" class="sort align-middle white-space-nowrap" data-sort="ket">
                                    Keterangan
                                </th>
                                <th style="min-width: 80px" class="sort align-middle white-space-nowrap" data-sort="tgl">
                                    Tanggal
                                </th>
                                <th style="min-width: 80px" class="sort align-middle white-space-nowrap" data-sort="kar">
                                    Karyawan
                                </th>
                                <th style="min-width: 250px; max-width: 400px;" class="sort align-middle white-space-nowrap"
                                    data-sort="kat">Kategori
                                </th>
