...
@section('judul')
    Kas Perusahaan | Validasi | HWA &bull; SAT
@endsection
...
@section('superadmin')
    ...
    @include('comp.modal.kas.modal_rekap_kas_create')
    @include('comp.modal.kas.modal_rekap_kas_edit')
    @include('comp.modal.kas.modal_rekap_kas_hapus')
