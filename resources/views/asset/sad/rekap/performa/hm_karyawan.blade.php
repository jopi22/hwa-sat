...
@section('judul')
    Performance Operator & Driver | Rekapitulasi | HWA &bull; SAT
@endsection
    ...
    <div class="card mb-2 bg-light shadow-none">
        ...
        <div class="card-header d-flex align-items-center z-index-1 p-0"><img
            ...
            <div class="ms-n3">
                ...
                <h4 class="mb-0 text-primary fw-bold">Performance Operator & Driver<span class="text-info fw-medium"></span>
                </h4>
            </div>
        </div>
    </div>
        ...
        <div class="card-header bg-light">
            <div class="d-lg-flex justify-content-between">
                <div class="row flex-between-center gy-2 px-x1">
                    <div class="col-auto pe-0">
                        <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                            ...
                            <a href="{{ route('r.hm.e') }}"><button class="btn btn-sm text-primary" type="button"><i
                                        class="fas fa-truck-monster"></i>
                                    Unit</button></a>
                            <a href="{{ route('r.hm.k') }}"><button class="btn btn-sm active text-warning"
                ...
                <div class="d-flex align-items-center justify-content-between justify-content-lg-end px-x1">
                    <div class="col-auto pe-0">
                        <a href="{{ route('r.hm.od.p.excel', Crypt::EncryptString(Auth::user()->id)) }}" target="_blank"
