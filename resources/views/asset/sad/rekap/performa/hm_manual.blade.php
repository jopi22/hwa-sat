...
<div class="card mb-2 bg-light shadow-none">
    ...
    <div class="card-header d-flex align-items-center z-index-1 p-0"><img
        ...
        <div class="ms-n3">
            ...
            <h4 class="mb-0 text-primary fw-bold">Kelola Hours Meter Manual<span class="text-info fw-medium"></span></h4>
        </div>
    </div>
</div>
                        ...
                        <div class="row flex-between-center gy-2 px-x1">
                            <div class="col-auto pe-0">
                                <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                                    <a href="{{ route('hm.create') }}"><button class="btn btn-sm text-primary" type="button"><i
                                                class="fas fa-stopwatch"></i> Reguler</button></a>
                                    <a href="{{ route('r.hm.m') }}"><button class="btn active btn-sm text-warning" type="button"><i
