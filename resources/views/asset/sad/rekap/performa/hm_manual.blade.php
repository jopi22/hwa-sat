...
@section('judul')
    HM Manual | Validasi | HWA &bull; SAT
@endsection
                    ...
                    <table class="table table-sm table-striped table-bordered mb-0 fs--1"
                        ...
                        <thead class="bg-secondary text-white">
                            <tr class="text-center">
                                ...
                                <th style="min-width: 120px" class="sort align-middle white-space-nowrap" data-sort="no">
                                    ID HM
                                </th>
                                <th style="min-width: 120px" class="sort align-middle white-space-nowrap" data-sort="tgl">
                                    Tanggal
                                </th>
                                ...
                                <th style="min-width: 350px; max-width: 400px;" class="sort align-middle white-space-nowrap"
                                    data-sort="name">Operator / Driver
                                </th>
                                ...
                                <th style="min-width: 100px" class="sort bg-primary align-middle white-space-nowrap">Jam
                                    Potongan
                                </th>
                                <th style="min-width: 100px" class="sort bg-primary align-middle white-space-nowrap">Jam
                                    Total
