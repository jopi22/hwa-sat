    ...
    <div class="card mb-2 bg-light shadow-none">
        ...
        <div class="card-header d-flex align-items-center z-index-1 p-0"><img
            ...
            <div class="ms-n3">
                ...
                <h4 class="mb-0 text-primary fw-bold">Helper<span class="text-info fw-medium"></span></h4>
            </div>
        </div>
    </div>
                    ...
                    <table class="table table-sm table-bordered mb-0 fs--1"
                        ...
                        <thead class="bg-200 text-800">
                            <tr class="text-center">
                                ...
                                <th style="min-width: 80px"
                                    class="sort bg-secondary text-white align-middle white-space-nowrap" data-sort="nik">
                                    NIK
                                </th>
