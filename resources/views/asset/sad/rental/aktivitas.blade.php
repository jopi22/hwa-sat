                    ...
                    <a href="javascript:void(0)" class="text-danger remove" title="Remove"><i class="fas fa-minus-square fs-2"></i></a>
                                                ...
                                                <td class="align-middle white-space-nowrap">
                                                    <input required type="text" maxlength="25"
                                                        class="form-control form-control-sm" name="aktivitas[]">
...
@section('konten')
        ...
        <div class="row gx-0 flex-between-center">
            <div class="col-sm-auto d-flex align-items-center"><img class="ms-n0"
                ...
                <div>
                    ...
                    <h4 class="text-primary fw-bold mb-0">Jenis Aktivitas</h4>
                </div>
            </div>
            ...
            <div class="tab-pane preview-tab-pane active" role="tabpanel"
                ...
                <div class="collapse" id="collapseExample">
                    <div class="border p-x1 rounded">
                        <form action="{{ route('aktivitas.s') }}" method="post">
                            @csrf
                    ...
                    <table class="table table-sm table-striped table-bordered mb-0 fs--1 overflow-hidden">
                        <thead class="bg-200 text-800">
                            <tr class="text-center">
                                ...
                                <th style="min-width: 150px" class="sort align-middle white-space-nowrap" data-sort="akt">
                                    Jenis Aktivitas
                                </th>
    ...
    @include('comp.modal.rental.modal_aktivitas_edit')
    @include('comp.modal.rental.modal_aktivitas_delete')
@endsection
