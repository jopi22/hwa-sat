...
@section('superadmin')
        ...
        <div class="row gx-0 flex-between-center">
            <div class="col-sm-auto d-flex align-items-center"><img class="ms-n0"
                ...
                <div>
                    ...
                    <h4 class="text-primary fw-bold mb-0">Location</h4>
                </div>
            </div>
            ...
            <div class="tab-pane preview-tab-pane active" role="tabpanel"
                ...
                <div class="collapse" id="collapseExample">
                    <div class="border p-x1 rounded">
                        <form action="{{ route('location.s') }}" method="post">
                            @csrf
    ...
    @include('comp.modal.rental.modal_location_edit')
    @include('comp.modal.rental.modal_location_delete')
@endsection
