...
<!-- ===============================================-->
@foreach ($kar as $res)
    <div class="modal fade" id="on-{{ $res->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
