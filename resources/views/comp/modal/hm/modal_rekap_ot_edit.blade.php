                                ...
                                <div class="col-lg-9">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="mb-2">
                                                <div class="form-floating">
                                                    <select disabled required name="kar_id" class="form-select form-select-sm"
                                                        id="floatingSelect"
                                                    ...
                                                    <input  type="hidden" name="kar_id" value="{{ $res->kar_id }}">
                                ...
                                <div class="col-lg-3">
                                    <ul class="nav flex-lg-column fs--1">
                                        ...
                                        <li class="nav-item me-2 mb-2 me-lg-0">
                                            ...
                                            <input class="form-control form-control-sm datetimepicker"
                                                id="datetimepicker" name="jam_selesai" type="text"
                                                data-options='{"enableTime":true,"dateFormat":"Y/m/d H:i","disableMobile":true}' />
                                            @error('jam_selesai')
                                                <div class="text-danger mt-2 fs--1">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <li class="nav-item me-2 mb-2 me-lg-0">
                                            ...
                                            <input class="form-control form-control-sm" name="jam_pot"
                                                type="number" />
                                            @error('jam_pot')
                                                <div class="text-danger mt-2 fs--1">{{ $message }}</div>
                                            @enderror
