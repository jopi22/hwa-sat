    ...
    <div class="modal-dialog modal-lg mt-6" role="document">
        <div class="modal-content border-0">
            ...
            <div class="modal-body p-0">
                <form action="{{ route('adjust.s') }}" method="post">
                    @csrf
                            ...
                            <div class="col-lg-12">
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <div class="mb-2">
                                            <div class="form-floating">
                                                <select required name="kar_id" class="form-select form-select-sm"
                                                    ...
                                                    <option selected=""></option>
                                                    @foreach ($kar as $s)
                                                        <option value="{{ $s->kar_->id }}">{{ $s->kar_->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="mb-2">
                                            <div class="form-floating">
                                                <input required type="text" name="ket"
                                    ...
                                    <div class="col-6">
                                        <div class="mb-2">
                                            <div class="form-floating">
                                                <select required name="kategori" class="form-select form-select-sm"
                                                    id="floatingSelect" aria-label="Floating label select example">
                                                    <option value=""></option>
                                        ...
                                        <div class="mb-2">
                                            <div class="form-floating">
                                                <input required type="number" name="nominal"
