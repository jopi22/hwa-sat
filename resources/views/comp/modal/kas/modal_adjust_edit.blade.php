                ...
                <div class="modal-body p-0">
                    <form action="{{ route('adjust.u', $item->id) }}" method="post">
                                ...
                                <div class="col-lg-12">
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="mb-2">
                                                <div class="form-floating">
                                                    <select required name="tgl" class="form-select form-select-sm"
                                                        ...
                                                        <option value="{{ $item->tgl }}">{{ $item->tgl }}</option>
                                                        @if ($master->total == 28)
                                            ...
                                            <div class="mb-2">
                                                <div class="form-floating">
                                                    <select required name="kar_id" class="form-select form-select-sm"
                                                        ...
                                                        <option value="{{ $item->kar_id }}">
                                                            {{ $item->kar_->name }}</option>
                                                        @foreach ($kar as $s)
                                            ...
                                            <div class="mb-2">
                                                <div class="form-floating">
                                                    <input required type="text" value="{{ $item->ket }}"
                                                        name="ket" class="form-control form-control-sm"
                                                        maxlength="20">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="mb-2">
                                                <div class="form-floating">
                                                    <input value="{{ $item->nominal }}" required type="number"
                                                        name="nominal" class="form-control form-control-sm">
                                                    <label for="floatingSelect">Nominal (Rp)</label>
                                                </div>
                                                @error('nominal')
                                                    <div class="text-danger mt-2 fs--1">{{ $message }}</div>
                                                @enderror
                        ...
                        <div class="modal-footer">
                            <button class="btn btn-warning btn-sm me-3"><i class="fas fa-magic"></i> Update</button>
                        </div>
                    </form>
                </div>
            </div>
