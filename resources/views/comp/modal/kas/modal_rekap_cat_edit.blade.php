        ...
        <div class="modal-dialog modal-lg mt-6" role="document">
            <div class="modal-content border-0">
                ...
                <div class="modal-body p-0">
                    <form action="{{ route('cat.u') }}" method="post">
                        @csrf
                                            ...
                                            <div class="mb-2">
                                                <div class="form-floating">
                                                    <input required type="number" max="100000000"
                                                        value="{{ $res->pagi }}" name="pagi"
                                                        class="form-control form-control-sm" id="floatingInput">
                                                    <label for="floatingTextarea2">Pagi</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-3">
                                            <div class="mb-2">
                                                <div class="form-floating">
                                                    <input required type="number" max="100000000"
                                                        value="{{ $res->siang }}" name="siang"
                                                        class="form-control form-control-sm" id="floatingInput">
                                                    <label for="floatingTextarea2">Siang</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-3">
                                            <div class="mb-2">
                                                <div class="form-floating">
                                                    <input required type="number" max="100000000"
                                                        value="{{ $res->sore }}" name="sore"
                                                        class="form-control form-control-sm" id="floatingInput">
                                                    <label for="floatingTextarea2">Sore</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-3">
                                            <div class="mb-2">
                                                <div class="form-floating">
                                                    <input required type="number" max="100000000"
                                                        value="{{ $res->malam }}" name="malam"
                                                        class="form-control form-control-sm" id="floatingInput">
                                                    <label for="floatingTextarea2">Malam</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
