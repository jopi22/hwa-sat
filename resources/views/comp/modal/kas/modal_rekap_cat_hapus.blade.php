            ...
            <div class="modal-content border-0">
                <div class="modal-header px-5 position-relative modal-shape-header bg-danger">
                    <div class="position-relative z-index-1 light">
                        <h5 class="mb-0 text-white" id="authentication-modal-label"><i class="fas fa-coins"></i> Hapus
                            Catering Tgl: {{ $res->tgl }}</h5>
                ...
                <div class="modal-footer">
                    <button class="btn btn-light" data-bs-dismiss="modal" aria-label="Close" type="button"><i
                            class="fas fa-times"></i> Batal</button>
                    <form action="{{ route('cat.d', $res->id) }}" method="post">
                        @csrf
