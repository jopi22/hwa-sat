                            ...
                            <div class="col-lg-12">
                                <div class="row">
                                    ...
                                    <div class="col-12 mb-2">
                                        <div class="form-floating">
                                            <input required type="number" max="100000000" name="jumlah"
                                                class="form-control form-control-sm" id="floatingInput">
                                            <label for="floatingTextarea2">Jumlah</label>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-floating">
