@foreach ($loc as $asu)
    <div class="modal fade" id="edit-{{ $asu->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog mt-6" style="max-width: 500px">
            <div class="modal-content">
                ...
                <form action="{{ route('location.u', $asu->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label class="form-label" for="jabatan">Location</label>
                            <input required maxlength="25" class="form-control" name="location"
                                value="{{ $asu->location }}" type="text" />
                        </div>
                        <div class="form-group">
