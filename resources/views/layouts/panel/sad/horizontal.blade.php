<nav class="navbar navbar-light navbar-glass navbar-top navbar-expand-lg" style="display: none;">
    ...
    @if (Auth::user()->level == 2)
        @include('layouts.panel.navbar.horizontal_superadmin')
    @endif
    @if (Auth::user()->level == 3)
        @include('layouts.panel.navbar.horizontal_hrga')
    @endif
    @if (Auth::user()->level == 4)
        @include('layouts.panel.navbar.horizontal_rental')
    @endif
    @if (Auth::user()->level == 5)
        @include('layouts.panel.navbar.horizontal_log')
    @endif
